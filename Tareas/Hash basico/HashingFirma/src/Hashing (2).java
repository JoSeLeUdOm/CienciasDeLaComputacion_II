...
public class Hashing {
    public static StringBuilder convertir32Bytes(){
        ...
        return convertir32Bytes(palabra);
    }

    //Overload: recibe el texto directamente (sin pedirlo por teclado).
    //Esto permite reutilizar el mismo pipeline de hashing para firmar
    //(clave + mensaje) sin depender de System.in.
    public static StringBuilder convertir32Bytes(String palabra){
    ...
    public static String Hash(){
        ...
        return HashDeTexto(ps1);
    }

    //Pipeline reutilizable: recibe el texto directamente (ya sea el mensaje
    //solo, o clave+mensaje concatenados) y devuelve el hash en hexadecimal.
    public static String Hash(String texto){
        StringBuilder ps1 = convertir32Bytes(texto);
        return HashDeTexto(ps1);
    }

    private static String HashDeTexto(StringBuilder ps1){
    ...
    // ================= FIRMA (Hash con clave / MAC casero) =================

    //Genera la "firma" de un mensaje: hashea la concatenación de clave+mensaje.
    //Solo quien conoce la clave puede regenerar la misma firma.
    public static String generarFirma(String mensaje, String claveSecreta){
        String combinado = claveSecreta + mensaje;
        return Hash(combinado);
    }

    //Verifica que una firma recibida corresponda al mensaje + clave.
    //Si el mensaje fue alterado, o la clave no coincide, el hash resultante
    //será distinto y la verificación fallará.
    public static boolean verificarFirma(String mensaje, String claveSecreta, String firmaRecibida){
        String firmaCalculada = generarFirma(mensaje, claveSecreta);
    ...
    public static void main(String[] args) {
        ...
        String firma = generarFirma(mensaje, clave);
